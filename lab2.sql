...
INSERT INTO employees (first_name, last_name, salary)
VALUES
('Alexey', 'Lebedev', 2, 118000),
('Irina', 'Novikova', 3, 93000),
('Pavel', 'Kozlov', 4, 125000),
('Maria', 'Fedorova', 5, 111000),
('Victor', 'Mikhailov', 1, 139000);
